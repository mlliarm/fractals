...
* How to compile a `.Rmd` file to `.html`: <http://kbroman.org/knitr_knutshell/pages/Rmarkdown.html>
* How to convert a `.Rmd` to a Jekyll friendly `.md`: <http://brooksandrew.github.io/simpleblog/articles/blogging-with-r-markdown-and-jekyll-using-knitr/>
